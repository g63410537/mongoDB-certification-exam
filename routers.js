        ...
        productCollection.findOne({ _id: productID })
            .then((product) => {
                ...
                if (action === "add") {
                    ...
                    if (!existingItem) {
                        user.wishlist.push({ productID, title: product.title });
                    }
        ...
        .then((user) => {
            ...
            productCollection.findOne({ _id: productID })
                .then((product) => {
                    ...
                    gamerCollection.findOneAndUpdate({ _id: userID }, { $set: { cart: user.cart } }, { new: true })
                        .then(updatedUser => {
...
app.put(EndPoints.ORDER, (req, res) => {
    ...
    gamerCollection.findOne({ _id: userID })
        .then((user) => {
            ...
            EndPoints.ORDER.insertOne(order)
                .then((result) => {
